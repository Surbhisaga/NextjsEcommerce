...
export default function shopList({ Allproducts }) {
                                        ...
                                        <div className="row">
                                            {
                                                Allproducts.map(product => {
                                                    return (
                                                        <div className={`col-lg-3 col-md-6 special-grid`} key={product.createdAt} >
...
export async function getServerSideProps(context) {
    const querySnap = await db.collection('products').orderBy('createdAt', "desc")
        .get()
