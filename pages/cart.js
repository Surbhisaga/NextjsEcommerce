...
const calculateProductsTotal = (products) =>
    products.reduce(
        (total, product) => total + product.productSellingPrice * product.quantity,
        0
    );

export default function cart({ Allproducts, user }) {
                                            ...
                                            return (
                                                <tr key={product.id}>
                                                    ...
                                                    <td className="price-pr">
                                                        <p>
                                                            {product.productCurrency} {product.productSellingPrice}
                                                        </p>
                                                    </td>
                                                    ...
                                                    <td className="total-pr">
                                                        <p>
                                                            ...
                                                            {product.quantity * product.productSellingPrice}
                                                        </p>
                                                    </td>
